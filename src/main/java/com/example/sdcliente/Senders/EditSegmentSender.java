...
import com.example.sdcliente.Senders.Data.EditSegmentData;
import com.example.sdcliente.Senders.Data.EditUserData;
import com.example.sdcliente.Services.SocketService;
import com.fasterxml.jackson.core.JsonProcessingException;

public class EditSegmentSender extends BaseSender implements IBaseSender {
    public EditSegmentSender(EditSegmentData data) {
        super(Actions.EDIT_SEGMENT, data);
    }

    public EditSegmentSender() {
        super();
    }
