...
public class EditUserSender extends BaseSender implements IBaseSender {
    public EditUserSender(EditUserData data) {
        super(Actions.EDIT_USER, data);
    }

    public EditUserSender() {
        super();
    }
