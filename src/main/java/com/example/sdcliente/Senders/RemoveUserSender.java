...
public class RemoveUserSender extends BaseSender implements IBaseSender {
    public RemoveUserSender(RemoveUserData data) {
        super(Actions.REMOVE_USER, data);
    }

    public RemoveUserSender() {
        super();
    }
